...
.stApp::before{content:'';position:fixed;inset:0;background-image:linear-gradient(rgba(240,168,32,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(240,168,32,0.04) 1px,transparent 1px);background-size:56px 56px;pointer-events:none;z-index:0}
.stApp::after{content:'';position:fixed;width:600px;height:600px;background:radial-gradient(circle,rgba(240,168,32,0.08) 0%,transparent 70%);top:-200px;right:-100px;border-radius:50%;filter:blur(100px);pointer-events:none;z-index:0}
...
.stTextInput>div>div>input{background:#101010 !important;border:1.5px solid #282828 !important;border-radius:14px !important;color:#f0ebe0 !important;font-family:'Sora',sans-serif !important;font-size:16px !important;padding:16px 20px !important;caret-color:#ffc040 !important;box-shadow:0 4px 24px rgba(0,0,0,0.4) !important}
...
.stButton>button{background:linear-gradient(135deg,#ffc040,#e09010) !important;color:#000 !important;border:none !important;border-radius:14px !important;font-family:'Sora',sans-serif !important;font-size:16px !important;font-weight:700 !important;padding:16px 28px !important;width:100% !important;box-shadow:0 4px 20px rgba(240,168,32,0.3) !important}
...
div[data-testid="column"] .stButton>button{background:transparent !important;color:#505050 !important;border:1px solid #1c1c1c !important;border-radius:100px !important;font-size:12px !important;font-weight:500 !important;padding:8px 14px !important;box-shadow:none !important;transform:none !important}
div[data-testid="column"] .stButton>button:hover{border-color:rgba(240,168,32,0.4) !important;color:#f0a820 !important;background:rgba(240,168,32,0.05) !important;transform:none !important}
</style>
